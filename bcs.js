...
setTimeout(() => {
  ...
  `;
    ...
    <span style="font-size: 1rem;">
      <a href="https://github.com/AnimeAbout/BiliBili-Custom-Subtitles/" target="_blank">v0.2 Update 3</a> |
      <a href="https://cutt.ly/anidev_" target="_blank">AniDev©</a> | Build for Firefox
    </span>
      `;
...
GM_addStyle(`
:root {
  --anidev-main-font: Cordia New;

  --anidev-main-color-text: var(--anidev-main-color-white);
  --anidev-main-color-white: #ffffff;
  --anidev-main-color-hotpink: #ff7fa8;
  --anidev-main-color-rosepink: #f7a5c1;
  --anidev-main-color-lavender: #ecbafc;
  --anidev-main-color-blizzard: #aee0f5;
  --anidev-main-color-blueeyes: #a8bcf2;

  --anidev-main-color-blueeyes-80: #a8bcf2cc;
}
...
.settings-button {
  ...
  background-color: var(--anidev-main-color-blueeyes);
  color: var(--anidev-main-color-text);
  font-family: var(--anidev-main-font);
  font-weight: bold;
  font-size: 1.4rem;
  word-break: break-word;

  border: 3px solid var(--anidev-main-color-lavender);
  border-radius: 5px;
}

.settings-button:hover {
  background-color: var(--anidev-main-color-rosepink);
  cursor: pointer;
}

.panel ::selection {
  background-color: var(--anidev-main-color-lavender);
  color: var(--anidev-main-color-text);
}
...
.settings-panel-name {
  ...
  border: solid 2px var(--anidev-main-color-lavender);
  border-radius: 10px;
}
...
.settings a {
  color: var(--anidev-main-color-hotpink);
  text-decoration: none;
}

.settings a:hover {
  color: var(--anidev-main-color-rosepink);
}
...
.settings li button {
  ...
  border: 2px solid var(--anidev-main-color-lavender);
  border-radius: 5px;
  transition: 0.2s;
}
...
.player-mobile .subtitle-item-text {
  ...
  font-family: var(--anidev-main-font), sans-serif !important;
  font-weight: bold !important;
  font-size: 150%;
  color: var(--anidev-main-color-text);
  text-shadow: -2px -2px 0 var(--anidev-main-color-hotpink),
    2px -2px 0 var(--anidev-main-color-hotpink),
    -2px 2px 0 var(--anidev-main-color-hotpink),
    2px 2px 0 var(--anidev-main-color-hotpink),
    -3px 0 0 var(--anidev-main-color-hotpink),
    3px 0 0 var(--anidev-main-color-hotpink),
    0 3px 0 var(--anidev-main-color-hotpink),
    0 -3px 0 var(--anidev-main-color-hotpink) !important;
